...
<!--    JavaScripts-->
<!-- ===============================================-->
<script src="<?=base_url('static/vendors/popper/popper.min.js')?>"></script>
<script src="<?=base_url('static/vendors/bootstrap/bootstrap.min.js')?>"></script>
<script src="<?=base_url('static/vendors/anchorjs/anchor.min.js')?>"></script>
<script src="<?=base_url('static/vendors/is/is.min.js')?>"></script>
<script src="<?=base_url('static/vendors/echarts/echarts.min.js')?>"></script>
<script src="<?=base_url('static/vendors/fontawesome/all.min.js')?>"></script>
<script src="<?=base_url('static/vendors/lodash/lodash.min.js')?>"></script>
<script src="https://polyfill.io/v3/polyfill.min.js?features=window.scroll"></script>
<script src="<?=base_url('static/vendors/list.js/list.min.js')?>"></script>
<script src="<?=base_url('static/assets/js/theme.js')?>"></script>
</body>
