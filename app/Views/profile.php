    ...
    <div class="card-body">
        <div class="row">
            <div class="col-lg-6">
                ...
                <?=@session()->get('user_details')['user']['name']?'<h5 class="text-primary mb-1">'.session()->get('user_details')['user']['name'].'</h5>':''?>
                <?=@session()->get('user_details')['user']['name']?'<p class="text-500 mb-1">'.session()->get('user_details')['user']['email'].'</p>':''?>
